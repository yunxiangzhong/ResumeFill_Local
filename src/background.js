...
function buildMessages(profileCatalog, scan) {
  ...
  const userPrompt = [
    ...
    "- For repeated sections like family father/mother, performance review rows, or education entries, use section and nearbyText to select the right profile path.",
